...
<head>
  ...
  <link type="text/css" rel="Stylesheet" href="<?php print __CA_URL_ROOT__.'/app/plugins/Pano360/' ?>lib/css/pannellum.css"/>
  <link type="text/css" rel="Stylesheet" href="<?php print __CA_URL_ROOT__.'/app/plugins/Pano360/' ?>lib/standalone.css"/>
</head>
<body>
<div id="container">
  <noscript>
...
<script type="text/javascript" src="<?php print __CA_URL_ROOT__.'/app/plugins/Pano360/' ?>lib/js/libpannellum.js"></script>
<script type="text/javascript" src="<?php print __CA_URL_ROOT__.'/app/plugins/Pano360/' ?>lib/js/RequestAnimationFrame.js"></script>
<script type="text/javascript" src="<?php print __CA_URL_ROOT__.'/app/plugins/Pano360/' ?>lib/js/pannellum.js"></script>
<script>
